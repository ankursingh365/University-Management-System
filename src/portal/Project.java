...
public class Project extends JFrame implements ActionListener{
    Project(){
        ...
        ImageIcon ic =  new ImageIcon(ClassLoader.getSystemResource("portal/icons/third.jpg"));
        ...
        JMenuItem m2 = new JMenuItem("Student Admission");
        master.setForeground(Color.BLUE);


        m1.setFont(new Font("monospaced",Font.BOLD,16));
        ImageIcon icon1 = new ImageIcon(ClassLoader.getSystemResource("portal/icons/icon1.png"));
        ...
        ImageIcon icon2 = new ImageIcon(ClassLoader.getSystemResource("portal/icons/icon2.png"));
        ...
        ImageIcon icon4 = new ImageIcon(ClassLoader.getSystemResource("portal/icons/icon3.png"));
        ...
        ImageIcon icon5 = new ImageIcon(ClassLoader.getSystemResource("portal/icons/icon4.jpg"));
        ...
        ImageIcon icon23 = new ImageIcon(ClassLoader.getSystemResource("portal/icons/icon14.jpg"));
        ...
        ImageIcon icon25 = new ImageIcon(ClassLoader.getSystemResource("portal/icons/icon15.png"));
        ...
        ImageIcon icon27 = new ImageIcon(ClassLoader.getSystemResource("portal/icons/icon15.png"));
        ...
        ImageIcon icon29 = new ImageIcon(ClassLoader.getSystemResource("portal/icons/icon14.jpg"));
        ...
        ImageIcon icon30 = new ImageIcon(ClassLoader.getSystemResource("portal/icons/icon16.png"));
        ...
        ImageIcon icon32 = new ImageIcon(ClassLoader.getSystemResource("portal/icons/icon17.png"));
        ...
        ImageIcon icon7 = new ImageIcon(ClassLoader.getSystemResource("portal/icons/icon5.png"));
        ...
        ImageIcon iconn = new ImageIcon(ClassLoader.getSystemResource("portal/icons/icon6.png"));
...
//        ImageIcon icon14 = new ImageIcon(ClassLoader.getSystemResource("portal/icons/icon7.png"));
...
//        ImageIcon icon16 = new ImageIcon(ClassLoader.getSystemResource("portal/icons/icon8.png"));
...
//        s2.addActionListener(this);
        ...
        ImageIcon icon18 = new ImageIcon(ClassLoader.getSystemResource("portal/icons/icon9.png"));
        ...
        ImageIcon icon20 = new ImageIcon(ClassLoader.getSystemResource("portal/icons/icon10.png"));
        ...
        ImageIcon icon10 = new ImageIcon(ClassLoader.getSystemResource("portal/icons/icon11.png"));
        ...
        ImageIcon icon21 = new ImageIcon(ClassLoader.getSystemResource("portal/icons/icon13.jpg"));
        ...
        ImageIcon icon11 = new ImageIcon(ClassLoader.getSystemResource("portal/icons/icon12.png"));
...
//        mb.add(fee);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(msg.equals("Student Admission")){
